...
public class ServantAdapterWithThumbnails extends ServantAdapter<ServantAdapterWithThumbnails.ViewHolder> {
    ...
    public ServantAdapterWithThumbnails(Context context) {
    ...
    @Override
    public ServantAdapterWithThumbnails.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ServantAdapterWithThumbnails.ViewHolder holder, int position) {
